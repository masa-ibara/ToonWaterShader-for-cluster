    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 normalLocal = ((node_6859*_NormalMapIntensity_var)+(0.5-(_NormalMapIntensity_var/2.0)));
...
////// Emissive:
                ...
                float3 emissive = ((_HighLightColor_var.rgb*node_2985)+(tex2D( _GrabTexture, (node_6859.rg+node_5179)).rgb*_Specular_var.rgb));
/// Final Color:
