    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 normalLocal = clamp(node_6859,(node_8033-_NormalMapIntensity_var),node_8033);
