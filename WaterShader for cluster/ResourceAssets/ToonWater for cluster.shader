...
Shader "forCluster/ToonWater" {
    Properties {
        ...
        [Normal]_node_708 ("node_708", 2D) = "bump" {}
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _node_708; uniform float4 _node_708_ST;
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 _node_708_var = UnpackNormal(tex2D(_node_708,TRANSFORM_TEX(i.uv0, _node_708)));
                ...
                float3 normalLocal = lerp(_node_708_var.rgb,node_6859,_NormalMapIntensity_var);
...
/////// Diffuse:
                ...
                float3 diffuseColor = saturate((node_9674+lerp(_DeepColor_var.rgb,lerp(_BaseColor_var.rgb,_DeepColor_var.rgb,pow(1.0-max(0,dot(i.normalDir, viewDirection)),_Fresnel_var)),node_1146)));
