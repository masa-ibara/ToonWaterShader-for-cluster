...
Shader "forCluster/New_Mirror_ToonWater" {
    Properties {
        ...
        [HideInInspector]_LeftEyeTexture ("LeftEyeTexture", 2D) = "black" {}
        _MirrorReflection_Intensity ("[Mirror]Reflection_Intensity", Range(0, 2)) = 0.5
        [HideInInspector]_RightEyeTexture ("RightEyeTexture", 2D) = "black" {}
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_2396 = 0.01;
                float2 node_9151 = (node_6870*_RefractionNoiseIntensity_var*node_5179*node_2396);
                float2 sceneUVs = (i.projPos.xy / i.projPos.w) + node_9151;
