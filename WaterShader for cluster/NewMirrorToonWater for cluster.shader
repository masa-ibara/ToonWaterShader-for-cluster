...
Shader "forCluster/New_Mirror_ToonWater" {
    Properties {
        ...
        _Reflection_Intensity ("Reflection_Intensity", Range(0, 2)) = 0.5
    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( float, _Reflection_Intensity)
...
////// Emissive:
                ...
                float _Reflection_Intensity_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Reflection_Intensity );
                ...
                float3 emissive = ((Function_node_7072( _LeftEyeTexture_var.rgb , _RightEyeTexture_var.rgb )*_Reflection_Intensity_var)+((_HighLightColor_var.rgb*node_423)+_EmissionColor_var.rgb+(Function_node_5374( reflect((viewDirection*(-1.0)),((i.tangentDir*node_1097.r)+(i.bitangentDir*node_1097.g)+(i.normalDir*node_1097.b))) )*_ReflectionProbeIntensity_var)));
/// Final Color:
